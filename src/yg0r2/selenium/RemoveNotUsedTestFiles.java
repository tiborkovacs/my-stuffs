...
public class RemoveNotUsedTestFiles {
	...
	public static void main(String[] args) throws Exception {
		String mainDir = "l:\\liferay-deprecated-test\\test-src\\";

		String[] functionalDirs = new String[] {
			"functional-6012-macro", "functional-6110-macro",
			"functional-6120-macro", "functional-6130-macro"
		};
